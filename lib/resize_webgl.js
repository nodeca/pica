...
shadersContent['#fsh-box-1d-covolve-horizontal'] =
  require('fs').readFileSync(__dirname + '/webgl/fsh-box-1d-covolve-horizontal.frag', 'utf8');
shadersContent['#fsh-box-1d-covolve-vertical'] =
  require('fs').readFileSync(__dirname + '/webgl/fsh-box-1d-covolve-vertical.frag', 'utf8');
shadersContent['#fsh-hamming-1d-covolve-horizontal'] =
  require('fs').readFileSync(__dirname + '/webgl/fsh-hamming-1d-covolve-horizontal.frag', 'utf8');
shadersContent['#fsh-hamming-1d-covolve-vertical'] =
  require('fs').readFileSync(__dirname + '/webgl/fsh-hamming-1d-covolve-vertical.frag', 'utf8');
...
function webglProcessResize(from, gl, options) {
  ...
  convolve(gl, texUnit0, srcW, srcH,
    texUnit2, shaders[winSize].horizontal, shaders[winSize].win, dstW, srcH, false);

  var finalFboObject = convolve(gl, texUnit2, dstW, srcH,
    texUnit3, shaders[winSize].vertical, shaders[winSize].win, dstW, dstH, true);
