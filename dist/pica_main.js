...
(function(global, factory) {
	...
	function gaussCoef(sigma) {
		if (sigma < .5) sigma = .5;
		const a = Math.exp(.527076) / sigma, g1 = Math.exp(-a), g2 = Math.exp(-2 * a), k = (1 - g1) * (1 - g1) / (1 + 2 * a * g1 - g2);
		const a0 = k;
		const a1 = k * (a - 1) * g1;
		const a2 = k * (a + 1) * g1;
		const a3 = -k * g2;
...
//# sourceMappingURL=pica_main.js.map